...
//				$_SESSION['reg_user_id']  = $uid;		
			...
			if ($rows === 2) { // Both are taken.
				...
				$reg_errors['email'] = '<span class="errorInForm">This email address has already been registered. If you have forgotten your password, use the link at left to have your password sent to you.</span>';			
				$reg_errors['username'] = '<span class="errorInForm">This username has already been registered. Please try another.</span>';			
				...
				if( ($row[0] === $_POST['email']) && ($row[1] === $_POST['username'])) { // Both match.
					$reg_errors['email'] = '<span class="errorInForm">This email address has already been registered. If you have forgotten your password, use the link at left to have your password sent to you.</span>';	
					$reg_errors['username'] = '<span class="errorInForm">This username has already been registered with this email address. If you have forgotten your password, use the link at left to have your password sent to you.</span>';
				} elseif ($row[0] === $_POST['email']) { // Email match.
					$reg_errors['email'] = '<span class="errorInForm">This email address has already been registered. If you have forgotten your password, use the link at left to have your password sent to you.</span>';						
				} elseif ($row[1] === $_POST['username']) { // Username match.
					$reg_errors['username'] = '<span class="errorInForm">This username has already been registered. Please try another.';			
				}
