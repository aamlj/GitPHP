<!--this file will take the post and check the password and username on mysql and allow deletion of users-->
...
{  
    $admin_name=$_POST['admin_name'];  // admin name from mysql
    $admin_pass=$_POST['admin_pass'];  //admin password from mysql
    ...
    {  
        ...
        echo "<script>window.open('view_users.php','_self')</script>";  //java script
    }  
