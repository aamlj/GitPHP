...
if ( isset($_GET ['id'] ) && ( strlen ( $_GET ['id'])  === 63 ) &&
(substr ($_GET ['id'], 0, 1)  !==  '.' ) ) {
...
$page_title = $row['title'];
 ...
 if (isset($_SESSION['user_id'])){
  echo '<div class="alert"><h4>Expired Account</h4>Thank 
  you for your interest in this content. Unfortunately your account 
...
content. You must be logged in as a registered user t0
 view this content.</div>';
 }
